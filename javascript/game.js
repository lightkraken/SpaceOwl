...
var graphics = {
	...
	load_sounds : function() {
		...
		this.sounds.combo1 = new Howl({src: 'sounds/combo1.mp3', onload: this.load_sounds_callback.bind(this)});
		this.sounds.combo2 = new Howl({src: 'sounds/combo2.mp3', onload: this.load_sounds_callback.bind(this)});
		this.sounds.combo3 = new Howl({src: 'sounds/combo3.mp3', onload: this.load_sounds_callback.bind(this)});
		this.sounds.combo4 = new Howl({src: 'sounds/combo4.mp3', onload: this.load_sounds_callback.bind(this)});
		this.sounds.ouch = new Howl({src: 'sounds/ouch.mp3', onload: this.load_sounds_callback.bind(this)});
		this.sounds.gem = new Howl({src: 'sounds/gem.mp3', onload: this.load_sounds_callback.bind(this)});
	},
